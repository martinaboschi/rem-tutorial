...
<div class="download-box">
  ...
  <ul>
    <li><a href="Alien-Species.R" download>Alien-Species.R</a> — R script</li>
    <li><a href="Alien-Species.Rmd" download> Alien-Species.Rmd</a> — R Markdown source</li>
    <li><a href="Alien-Species.zip" download>Alien-Species.zip</a> — working directory with all data and image files needed to replicate the full analysis</li>
  </ul>
</div>

If you plan to run the R Markdown file, make sure to place it in the same folder as the extracted contents of `Alien-Species.zip`.

{% include_relative Alien-Species.md %}
