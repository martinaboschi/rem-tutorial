...
We know format the data in a convenient manner for analysis using `amore` package. We need to make sure that both the data structures for the sequence of relational events and the set of dyads not at risk at the beginning of the time-window contain a `sender` and `receiver` column. 
