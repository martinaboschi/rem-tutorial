...
These notes accompany the two workshop sessions:

- Introduction to relational event models;
- All you need to know about relational hyperevent modeling;

The notes are authored by **Martina Boschi, Melania Lembo, Jürgen Lerner, and Ernst C. Wit**.

<div class="notes-grid">

<a class="notes-box" href="./notes-p1" style="background: #fffbeb;">
...
<a class="notes-box" href="./notes-p2" style="background: #eff6ff;">
<span class="rem-icon">📖</span>
<span class="notes-tag tag-red">Workshop 2</span>
<span class="notes-title">Relational Hyper-Event Modeling</span>
<span class="notes-sub">Core RHEMs, directed hyperevents, and non-linear RHEMs</span>
<span class="notes-arrow">→</span>
</a>
