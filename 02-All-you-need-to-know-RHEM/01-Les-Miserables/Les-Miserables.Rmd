...
In the two practicals of the workshop *All You Need to Know About Relational Hyper-Event Modeling*, we show how to use `amore` to fit relational hyper-event models with increasing levels of complexity.
