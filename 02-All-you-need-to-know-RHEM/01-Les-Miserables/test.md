...
several of 288 chapters. The (binary) gender of the actors is known.
...
1)  **Based on the data structures you were given and those you
...
We find a . This suggests that prior (co-)presence in previous
chapters - whether alone or in pairs - increases the rate of
participating in events. A negative effect for diff.female suggests a
positive effect for gender homophily, favouring co-appearence with other
actors of the same gender.
